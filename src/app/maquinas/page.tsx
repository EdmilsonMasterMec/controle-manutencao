...
type Equipamento = {
  ...
  /*
   * Campos opcionais.
   * Se existirem na tabela, serão exibidos.
   * Caso não existam, a página continua funcionando.
   */
  placa?: string;
  chassi?: string;
  numero_serie?: string;
...
export default function MaquinasPage() {
  ...
  async function carregarDados() {
    ...
    if (data) {
      ...
      /*
       * Se a página foi aberta pelo QR Code:
       *
       * /maquinas?id=10
       *
       * automaticamente abre o equipamento 10.
       */
   ...
   * QR CODE
   *
   * O QR continua contendo o endereço individual
   * do equipamento.
   * ============================================================
   */
  ...
  return (
    <main className="Robert-app">
      ...
      <div className="page-container">
         ...
         *
         * Os quatro botões ficam ACIMA do primeiro dado.
         * ======================================================
         */}
        ...
        <style jsx>{`
           ...
           *
           * Os ícones continuam acima do Fabricante.
           * =====================================================
           */
          ...
          @media (max-width: 768px) {
            ...
            .tabela-equipamentos td:last-child {
              border-bottom:
                none !important;
            }
